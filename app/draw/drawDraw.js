...
(function (jat) {
    (function (_draw) {
        var drawCtrl = (function () {
            function drawCtrl(drawLib, find) {
        ...
        angular.module('jat.draw.list', ['jat.services.drawLib', 'jat.services.find']).directive('draw', drawDirective).directive('drawLines', drawLinesDirective);
    })(jat.draw || (jat.draw = {}));
    var draw = jat.draw;
})(jat || (jat = {}));
