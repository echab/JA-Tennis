...
namespace JA_Tennis.ComponentModel
{
    ...
    /// </summary>
    public class BindableType : INotifyPropertyChanged, IBindableBehaviors
    {
        public BindableType()
            : this(null)
        {
        }
        public BindableType(IBindableBehaviors parentAggregate)
        {
            ...
            {
                parentAggregate.ChangeBehaviors.ForEach(b => ChangeBehaviors.Add(b));
            }
        }


        #region IBindableBehaviors Members
        protected List<IPropertyChangedBehavior> _ChangeBehaviors;
        public List<IPropertyChangedBehavior> ChangeBehaviors { get { return _ChangeBehaviors; } }
        #endregion
        ...
        private void Set<T>(ref T local, T newVal, string name)
        {
            ...
            //INotifyPropertyChanging notifyPropertyChanging = (INotifyPropertyChanging)this;
    ...
    public interface IBindableBehaviors
    {
        List<IPropertyChangedBehavior> ChangeBehaviors { get; }
    }
}