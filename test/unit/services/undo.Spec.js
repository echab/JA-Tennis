...
describe('services.undo', function () {
    ...
    describe('testAction', function () {
        ...
        it('should insert e', function () {
            var r = undo.action(function (bUndo) {
                if (!bUndo) {
                    a.e = 'ee';
                }
                else {
    ...
    describe('group function meta', function () {
        var a = {
            v: 0,
            w: 1
        };
    ...
    describe('group error', function () {
        ...
        it('should not cancel no group', function () {
            expect(function () { return undo.cancelGroup(); }).toThrow('No group defined');
        });
        it('should not end no group', function () {
            expect(function () { return undo.endGroup(); }).toThrow('No group defined');
        });
        it('should not imbricate group', function () {
            undo.newGroup('grouping');
            expect(function () { return undo.newGroup('grouping again'); }).toThrow("Cannot imbricate group");
            undo.cancelGroup();
        });
    });
