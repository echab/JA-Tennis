...
function validateDraw(tournament: Tournament, event: TEvent, draw: Draw): DrawProblem[] {
    ...
    //	#ifdef _DEBUG
    ////				wsprintf( gszBuf, "FFTT: VerifieEpreuve( \"%s\")", epreuve.Nom);
    ...
    //	#ifdef _DEBUG
    ////				wsprintf( gszBuf, "FFTT: VerifieTableau( \"%s\", \"%s\")", epreuve.Nom, tableau.Nom);
    ////				glpfn.AddMessage( pDoc, gszBuf, &sel);
    //	#endif //_DEBUG
...
export const FFTTValidation: IValidation = { validatePlayer, validateDraw };
