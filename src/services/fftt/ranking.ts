...
import { ScoreDeltaFFTT} from './score';

export class RankingFFTT implements Ranking {

    // private _serviceScore: ScoreFFTT;

    constructor(
        score: Score) {
        // this._serviceScore = score as ScoreFFTT;
    }
    ...
    AddResultat(bVictoire: number, score: string, fm: string): boolean {	//-1=défaite, 0=nul, 1=victoire
        ...
        const sc = new ScoreDeltaFFTT(score, fm);
