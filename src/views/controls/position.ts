...
export class Position {
      ...
      positionElements(hostElem, targetElem, placement, appendToBody) {
        ...
        var targetWidth = 'undefined' !== typeof (targetElem.offsetWidth) ? targetElem.offsetWidth : targetElem.prop('offsetWidth');
        var targetHeight = 'undefined' !== typeof (targetElem.offsetHeight) ? targetElem.offsetHeight : targetElem.prop('offsetHeight');
